...
class ComplainceTeamLead extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentWillMount() {
        ...
        var usertype = 'ComplainceTeamLeader'
    ...
    userAdd(e) {
        ...
        var obj={
         ...
         user_type :'ComplainceTeamLeader' 
        }
...
submit(e){
    ...
    render() {
        return (
            ...
            <div className="tab-pane active" id="compliance-team-lead">
                <p className="lead">Compliance Team Lead</p>
                            ...
                            <tbody id="yui_3_17_2_1_1516171062459_91"><tr id="yui_3_17_2_1_1516171062459_90">
                                <td id="existingcell">
                                    <p id="yui_3_17_2_1_1516171062459_89">
                                        <label htmlFor="removeselect" id="yui_3_17_2_1_1516171062459_88">Current Compliance Team Leads</label>
                                    </p>
                                    <div className="userselector" id="removeselect_wrapper">
                                        <select name="removeselect" id="removeselect" size="20" className="form-control no-overflow">
                                            <optgroup label={"Compliance Team Lead(" +this.state.adminUserDetails.length+")"}>
                                        ...
                                        <div className="form-inline">
                                            <label htmlFor="removeselect_searchtext">Search</label>
                                            <input type="text" name="removeselect_searchtext" id="removeselect_searchtext" size="15" value="" className="form-control" />
                                ...
                                <td id="buttonscell">
                                    <p className="arrow_button">
                                        ...
                                        <input onClick={this.submit} name="main" id="main" type="submit" value="Set Team Lead" title="Set Team Lead" className="btn btn-primary" />
                                    </p>
                                </td>
                                <td id="potentialcell">
                                    <p>
                                    ...
                                    <div className="userselector" id="addselect_wrapper">
                                        ...
                                        <div className="form-inline">
                                            <label htmlFor="addselect_searchtext">Search</label><input type="text" name="addselect_searchtext" id="addselect_searchtext" size="15" value="" className="form-control" />
...
export default connect(mapStateToProps, mapDispatchToProps)(ComplainceTeamLead);
