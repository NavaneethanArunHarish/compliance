...
import getSar from '../../../../SAR_module/actions';
...
var arrayData = [];
class SARDetailsRepresentative extends Component {
    constructor(props) {
        super(props);
        this.state = {
            sarData: {},
...
export default connect(mapStateToProps, mapDispatchToProps)(SARDetailsRepresentative);
