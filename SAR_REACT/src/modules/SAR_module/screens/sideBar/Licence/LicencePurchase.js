...
class LicencePurchaseComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <center><button class="btn btn-primary btn-lg">Purchase</button></center>
                        </div>
                      </div>
...
export default LicencePurchaseComponent;
