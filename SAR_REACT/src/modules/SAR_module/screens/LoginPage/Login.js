...
class Login extends Component {
  ...
  userResponse(response) {
    ...
    browserHistory.push({
      ...
      state: { email, pwd, data,loginResponse: data }
    });
    // let getData  = localStorage.getItem("data");
    // var data = JSON.parse(getData);
    ...
    //           browserHistory.push({
    //             pathname: '/sar/reps/SAR-dashboard',
    //             state: { email, pwd, data },
    //           });
    ...
    if (value !== undefined) {
      ...
      if (Object.keys(value).length !== 0) {
        if (value.success.message !== null) {
          ...
          this.setState({ loginStatus: value.success.message });
            ...
            <div className="animate form login_form">
              ...
              <section className="login_content">
                ...
                <form>
                  ...
                  {this.state.loginStatus !== '' && <div className="alert alert-danger alert-dismissible fade in" role="alert">
              ...
              <p className="login_bottom">Don't have an account? <a onClick={this.signUp}>Signup</a></p>
            </div>
          </div>
        </div>
      </div>
