...
class UserDPO extends Component {
    constructor(props) {
        super(props);
            this.state = {
                allUserDetails: [],
        ...
        return (
            <div className="col-xs-10">
                ...
                <div className="tab-content">
                    <div className="tab-pane active" id="dpo-lead">
                        <p className="lead">Data Protection Officer (DPO)</p>
                                    ...
                                    <tbody id="yui_3_17_2_1_1516171062459_91"><tr id="yui_3_17_2_1_1516171062459_90">
                                        <td id="existingcell">
                                            <p id="yui_3_17_2_1_1516171062459_89">
                                                <label htmlFor="removeselect" id="yui_3_17_2_1_1516171062459_88">Current Data Protection Officer (DPO)s</label>
                                            </p>
                                            <div className="userselector" id="removeselect_wrapper">
                                                <select name="removeselect" id="removeselect" size="20" className="form-control no-overflow">
                                                    <optgroup label={"DPO (" +this.state.adminUserDetails.length+")"}>
                                        ...
                                        <td id="buttonscell">
                                            <p className="arrow_button">
                                                ...
                                                <input onClick={this.submit} name="main" id="main" type="submit" value="Set DPO" title="Set DPO" className="btn btn-primary" />
                                            </p>
                                        </td>
                                        <td id="potentialcell">
                                            <p>
...
export default connect(mapStateToProps, mapDispatchToProps)(UserDPO);
