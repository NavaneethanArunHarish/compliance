...
class DPIAListQuestion extends Component {
    constructor(props) {
        super(props);
        this.state = {
            navBar: 'nav-md',
    ...
    editQuestions(e, obj) {
        ...
        // browserHistory.push('/dpia/answerQuestions/' + this.props.location.state.id + '/' + obj.section_id + '/' + obj.id)
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(DPIAListQuestion);