...
class ComplainceTeamMember extends Component {
    constructor(props) {
        super(props);
        this.state = {
            allUserDetails: [],
    ...
    userAdd(e) {
        ...
        var obj={
         ...
         user_type :'ComplainceTeamMember' 
        }
 ...
 submit(e){
    ...
    render() {
        return (
            ...
            <div className="tab-pane active" id="compliance-team-member">
                <p className="lead">Compliance Team Member</p>
                            ...
                            <tbody id="yui_3_17_2_1_1516171062459_91"><tr id="yui_3_17_2_1_1516171062459_90">
                                <td id="existingcell">
                                    <p id="yui_3_17_2_1_1516171062459_89">
                                        <label htmlFor="removeselect" id="yui_3_17_2_1_1516171062459_88">Current Compliance Team Members</label>
                                    </p>
                                    <div className="userselector" id="removeselect_wrapper">
                                        <select name="removeselect" id="removeselect" size="20" className="form-control no-overflow">
                                            <optgroup label={"Compliance Team Member (" +this.state.adminUserDetails.length+")"}>
                                ...
                                <td id="buttonscell">
                                    <p className="arrow_button">
                                        ...
                                        <input onClick={this.submit} name="main" id="main" type="submit" value="Set Team Member" title="Set Team Member" className="btn btn-primary" />
                                    </p>
                                </td>
                                <td id="potentialcell">
                                    <p>
...
export default connect(mapStateToProps, mapDispatchToProps)(ComplainceTeamMember);